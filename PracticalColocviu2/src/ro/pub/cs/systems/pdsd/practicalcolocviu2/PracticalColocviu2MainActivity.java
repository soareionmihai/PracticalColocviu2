package ro.pub.cs.systems.pdsd.practicalcolocviu2;


import ro.pub.cs.systems.pdsd.practicalcolocviu2.R;
import ro.pub.cs.systems.pdsd.practicalcolocviu2.Constants;
import ro.pub.cs.systems.pdsd.practicalcolocviu2.ClientThread;
import ro.pub.cs.systems.pdsd.practicalcolocviu2.ServerThread;
...
public class PracticalColocviu2MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_practical_colocviu2_main);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.practical_colocviu2_main, menu);
		return true;
	}
